...
exports.validateBasic = function (request, username, password, h) { return __awaiter(void 0, void 0, void 0, function () {
    var user, isValid;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('Basic AUTH');
                return [4 /*yield*/, validate_database_1.default(username)];
            case 1:
                user = _a.sent();
                if (!user) {
            ...
            case 2:
                ...
                return [2 /*return*/, { isValid: isValid, credentials: user }];
        }
    });
}); };
