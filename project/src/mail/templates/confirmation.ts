                                ...
                                <tbody>
                                  <tr>
                                    <td role="modules-container"
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img class="max-width" border="0"
                                                                ...
                                                                width=140" alt="" data-proportionally-constrained="true"
                                                                data-responsive="false"
                                                                src = "https://pickalook.co/img/LogoText.90b2bef1.svg"
                                                                width="140">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 43px">Gracias por Registrarte&nbsp;</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Por favor, verifica tu email para poder disfrutar del servicio
                                                                   </span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #f50057; font-size: 18px"><strong>Disfrútalo!&nbsp;</strong></span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#f50057"
                                                                      ...
                                                                      <a href="https://pickalook.co?verify=${token}"
                                                                        style = "background-color:#f50057; border:1px solid #f50057; border-color:#f50057; border-radius:0px; border-width:1px; color:#FFFFFF; font-weight: bold; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                                        target="_blank">Verificar Email Ahora</a>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #ffffff; font-size: 18px"><strong>Esto ocurrirá ahora:</strong></span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <br></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="color: #ffffff; font-size: 18px">1.
                                                                    Vota las prendas dependiendo de si te gusta más o menos.</span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <br></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="color: #ffffff; font-size: 18px">2.
                                                                    Aprenderemos de ti y te ofreceremos prendas que te gusten más.</span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <br></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="color: #ffffff; font-size: 18px">3. Guarda y compra aquellas prendas que más te gusten.</span></div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" class="module"
                                        data-role="module-button" data-type="button" role="module"
                                        style="table-layout:fixed; margin-top: 24px;" width="100%"
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                                      style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                      <a href="https://twitter.com/VersyCreate"
                                                        ...
                                                        target="_blank">DONE WITH ♥ BY @VersyCreate</a></td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </td>
