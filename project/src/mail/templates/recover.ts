                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 43px">Recupera tu
                                                                    Contraseña&nbsp;</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Alguien ha pedido una
                                                                    contraseña nueva con este email
                                                                  </span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#f50057"
                                                                      ...
                                                                      <a href="https://pickalook.co/recoverPassword?token=${token}"
                                                                      ...
                                                                      <div style="margin-top: 16px">
                                                                        O copia este enlace: <a
                                                                          href="https://pickalook.co/recoverPassword?token=${token}">https://pickalook.co/recoverPassword?token=${token}</a>
                                                                      </div>
                                                                      <i
                                                                        style="margin-top: 16px; display: inline-block">Este
                                                                        enlace funcionará hasta mañana</i>
                                                                      <p style="margin: 16px">Si no has realizado
                                                                        esta petición, puedes
                                                                        ignorar este mensaje o hacernoslo saber, tu
                                                                        contraseña no será cambiada si no finalizas el
                                                                        proceso.</p>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
